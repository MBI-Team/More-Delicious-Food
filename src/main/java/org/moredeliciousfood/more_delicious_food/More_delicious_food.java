package org.moredeliciousfood.more_delicious_food;
...
@Mod(More_delicious_food.MODID)
public class More_delicious_food {
    ...
    public More_delicious_food(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (More_delicious_food) to respond directly to events.
